...
+ (PMSSCustomerFactory *)sharedInstance
{
    ...
    dispatch_once(&t, ^{
        ...
        [customerFactory buildCustomerData];
    });
...
- (void)buildCustomerData
{
    ...
    NSArray *customerDataArray = @[@{@"Name":@"马丁",@"LevelName":@"普通卡",@"MemberId":@"6236609999",@"Points":@"9860"},@{@"Name":@"王立",@"LevelName":@"金卡",@"MemberId":@"6630009999",@"Points":@"48860"},@{@"Name":@"李想",@"LevelName":@"白金卡",@"MemberId":@"8230009999",@"Points":@"98860"},@{@"Name":@"张三",@"LevelName":@"钻石卡",@"MemberId":@"9230009999",@"Points":@"198860"}];
